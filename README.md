...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-31 12:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9eded773-4830-485c-862c-2aded7a50fc1.git
$ cd 9eded773-4830-485c-862c-2aded7a50fc1
```
